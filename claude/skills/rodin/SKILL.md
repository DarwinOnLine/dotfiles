...
version: 1.0.0
author: https://github.com/bdebon
---
...
1. Consulte les mémoires de type `user` dans le système de mémoire de Claude Code (dossier `memory/` du projet courant et du projet global `~/.claude/projects/-home-darwin/memory/`). Ce sont ton contexte permanent sur ton interlocuteur. Ne les résume pas, ne les mentionne pas. Intègre-les silencieusement.
...
Appuie-toi sur les mémoires de type `user` du système de mémoire de Claude Code pour connaître ton interlocuteur (parcours, domaines d'expertise, biais connus, centres d'intérêt).
